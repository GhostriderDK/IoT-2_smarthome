...
def stue_temp():
    ...
    ax1.plot(timestamps, temp, linestyle="dashed", c="#11f", linewidth="1.5")
    ...
    ax2.plot(timestamps, hum, linestyle="dashed", c="#11f", linewidth="1.5")
...
def stue_data_co2_tvoc_part():
    ...
    fig.subplots_adjust(bottom=0.3)
    ax1.set_facecolor("white")
    ax1.plot(timestamps, tvoc, linestyle="dashed", c="#11f", linewidth="1.5")
    ...
    ax2.tick_params(axis='x', which='both', rotation=90)
    ax2.set_facecolor("white")
    ax2.plot(timestamps, co2, linestyle="dashed", c="#11f", linewidth="1.5")
    ax2.set_xlabel("Timestamps")
...
def part_in_air():
    ...
    ax.plot(timestamps, part, linestyle="dashed", c="#11f", linewidth="1.5")
